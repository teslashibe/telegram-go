...
// Excluded enumerates exported methods on *telegram.Client that are
...
var Excluded = map[string]string{
	...
	"Connect":    "performs interactive SMS/2FA auth — host wires this once at startup, not exposed as a runtime tool",
